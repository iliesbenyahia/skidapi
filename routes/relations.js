...
const relationshipsController = require('../controller/ressourceRelationshipsController');
...
router.get('/', relationshipsController.fetchAll);
//router.get('/:id',relationshipsController.fetch);
